...
export const CLM_URLS = {
    ...
    COMPARE: `${BASE_URL}/document_compare`, //AI 계약 내용 비교 
...
export function getCurrentLoginCredentials() {
    const email = (typeof __ENV !== 'undefined' && __ENV.LOGIN_EMAIL) ? __ENV.LOGIN_EMAIL
        : (typeof process !== 'undefined' && process.env.LOGIN_EMAIL) ? process.env.LOGIN_EMAIL
        : null;
    const password = (typeof __ENV !== 'undefined' && __ENV.LOGIN_PASSWORD) ? __ENV.LOGIN_PASSWORD
        : (typeof process !== 'undefined' && process.env.LOGIN_PASSWORD) ? process.env.LOGIN_PASSWORD
        : null;
